				...
				<div class="col-sm-9">
					<form action="/recharge_list.do" name="searchForm" id="searchForm" class="form-inline">
						...
						<div class="form-group">
							<label>时间范围</label>
							<input type="text" class="form-control beginTime" name="beginTime" value="${(qo.beginTime?string('yyyy-MM-dd'))!''}"/>
						</div>
						<div class="form-group">
							<label></label>
							<input type="text" class="form-control endTime" name="endTime" value="${(qo.endTime?string('yyyy-MM-dd'))!''}"/>
						</div>
						<div class="form-group">
						    <label>状态</label>
