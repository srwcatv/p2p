...
<script type="text/javascript">
	$(function() {
		...
		$(".auditClass").click(function(){
			...
			$("#editForm [name=username]").html(data.username);
			$("#editForm [name=tradeCode]").html(data.tradeCode);
			$("#editForm [name=amount]").html(data.amount);
			$("#editForm [name=tradeTime]").html(data.tradeTime);
		});
