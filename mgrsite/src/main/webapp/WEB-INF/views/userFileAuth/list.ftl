		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<form id="searchForm" class="form-inline" method="post" action="/userFileAuth.do">
					...
					<div class="form-group">
					    <label>申请时间</label>
					    <input class="form-control" type="text" name="beginTime" id="beginTime" value="${(qo.beginTime?string('yyyy-MM-dd'))!''}" />到
					    <input class="form-control" type="text" name="endTime" id="endTime" value="${(qo.endTime?string('yyyy-MM-dd'))!''}" />
					</div>
					<div class="form-group">
		      	...
		      	<form class="form-horizontal" id="editform" method="post" action="/userFile_audit.do">
					<fieldset>
			        	...
			        	<div class="col-sm-6" style="width: 500px;height: 500px;">
			        		<img src="" class="img-responsive" id="image" style="width:auto;height: auto"/>
			        	</div>
			        	</div>
			        	<div class="form-group">
